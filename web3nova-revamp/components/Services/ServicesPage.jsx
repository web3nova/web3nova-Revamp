...
function TechTicker() {
  ...
  return (
    <section className="sticky top-16 md:top-20 z-40 py-6 overflow-hidden" style={{ backgroundColor: '#4A90E2' }}>
  ...
  const testimonials = [
    {
      ...
      image: "SJ",
      content: "Working with this team transformed our vision into reality. Their expertise in smart contracts and DeFi is unmatched.",
    ...
    },
    {
      ...
      image: "MC",
      content: "The NFT marketplace they built exceeded our expectations. Seamless user experience and rock-solid security.",
      project: "Art NFT Platform",
      color: "#FDB913"
    },
    {
      name: "Emily Rodriguez",
      role: "CTO, Web3 Gaming",
      image: "ER",
      content: "Outstanding blockchain integration! They delivered a scalable solution that handles thousands of transactions daily.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 
            ...
            style={{ fontFamily: 'Space Grotesk, sans-serif' }}
          >
            What Our <span className="bg-gradient-to-r from-yellow-400 to-blue-400 bg-clip-text text-transparent">Clients Say</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
            ...
            >
              <div className="relative h-full rounded-3xl p-8 bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 hover:border-white/20 backdrop-blur-sm transition-all duration-500 hover:scale-105 overflow-hidden">
                ...
                <div 
                  ...
                  style={{ backgroundColor: testimonial.color, fontFamily: 'Space Grotesk, sans-serif' }}
                >
                  {testimonial.image}
                </div>
                ...
                <div className="border-t border-white/10 pt-4">
                  <h4 className="text-white font-bold mb-1" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                    {testimonial.name}
                  </h4>
                  <p className="text-gray-400 text-sm mb-2" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                    {testimonial.role}
                  </p>
                  <div 
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-block px-6 py-2 rounded-full mb-4 bg-blue-500/10 border border-blue-500/20">
            <span className="text-blue-400 font-semibold text-sm" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              ⚡ What We Offer
            </span>
          </div>
          <h2 
        ...
        <div className="text-center mt-16">
          ...
          <button 
            ...
            style={{ fontFamily: 'Space Grotesk, sans-serif', boxShadow: '0 8px 32px rgba(74, 144, 226, 0.4)' }}
          >
        ...
        <div className="relative" style={{ perspective: '1500px' }}>
          ...
          >
            <div className="flex animate-slide-right gap-6 py-4">
              {[...techStack.slice(0, 5), ...techStack.slice(0, 5)].map((tech, index) => (
                <div
                  key={`row1-${index}`}
          ...
          >
            <div className="flex animate-slide-left gap-6 py-4">
              {[...techStack.slice(5, 10), ...techStack.slice(5, 10)].map((tech, index) => (
                <div
                  key={`row2-${index}`}
                  className="relative flex-shrink-0 px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 hover:scale-110 cursor-pointer overflow-hidden group"
                  style={{ 
          ...
          >
            <div className="flex animate-slide-right-slow gap-6 py-4">
              {[...techStack.slice(10, 15), ...techStack.slice(10, 15)].map((tech, index) => (
                <div
                  key={`row3-${index}`}
                  className="relative flex-shrink-0 px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 hover:scale-110 cursor-pointer overflow-hidden group"
                  style={{ 
