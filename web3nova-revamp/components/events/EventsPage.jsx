  ...
  return (
    <section className="relative z-10 py-20 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-500/20 rounded-full blur-3xl animate-pulse-slow" />
      </div>

      <div className="container mx-auto px-6 relative z-10">
        <div 
          className="relative rounded-[3rem] p-12 md:p-20 overflow-hidden max-w-6xl mx-auto text-center"
          style={{ 
            background: 'linear-gradient(135deg, #5A9FE8 0%, #7BB5EC 100%)',
            boxShadow: '0 25px 60px rgba(74, 144, 226, 0.3)'
          }}
        >
          ...
          <div className="relative">
            <div className="inline-block px-6 py-2 rounded-full mb-6 bg-white/20 backdrop-blur-sm border border-white/30" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
            ...
            <h1 className="text-4xl md:text-7xl font-bold mb-6 text-white leading-tight" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Web3Nova <span className="text-blue-200">Events</span>
            </h1>

            <p className="text-xl md:text-2xl max-w-3xl mx-auto text-white/90 leading-relaxed" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Join us at workshops, meetups, and conferences across Nigeria
            </p>

            <div className="mt-10 flex flex-wrap justify-center gap-6">
              {[
                { icon: <Calendar className="w-5 h-5" />, text: "6+ Events" },
                { icon: <Users className="w-5 h-5" />, text: "500+ Attendees" },
                { icon: <MapPin className="w-5 h-5" />, text: "Web3Nova Community" }
              ].map((stat, index) => (
                <div key={index} className="flex items-center gap-2 text-white/90" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                  {stat.icon}
